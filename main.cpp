...
delay(500);
	...
	switch(count)
	{
		...
		case 1:cout<<"\nDid you forgot password ???"
			<<"\nFor SUPPORT & HELP CONTACT ADMIN :";
			break;
...
//HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH
//      function to customize the theprogrammsetings
//HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH
...
<<"\n otherwise the program will run with default values"
		...
		<<"\n\nFOREXAMPLE:Suppose first 200 units are charged with Rs.2.45 and "
	...
	cout<<"\n\nOptions:\nOptions contain all necessary options to cutomize program."
		...
		<<"\nIf the program show abnormal behaviourgoto 'options' and choose 'default settings\n";
...
void billgen::credit()
{
			cout<<endl;
			cout<<"\n\n 23 Nov 2015\n";
			cout<<"\nProject name   :ElectricBill-gen";
			cout<<"\nCreated by     :SHUBHANGI SHUKLA AND SAURABH KUMAR";
